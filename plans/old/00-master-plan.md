...
- `23-performance-efficiency-roadmap.md` — measured execution roadmap spanning evaluation/CI, bounded concurrency, streaming versioned ingestion, adaptive RAG, retrieval safety, index/read scaling, client responsiveness, and production capacity validation.
- `24-production-validation-runbook.md` — synthetic-data load ladder, ingestion recovery, soak, and dependency failure drills.
